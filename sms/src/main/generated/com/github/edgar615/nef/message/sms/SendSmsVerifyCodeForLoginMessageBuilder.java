...
public final class SendSmsVerifyCodeForLoginMessageBuilder {
  ...
  private SendSmsVerifyCodeForLoginMessageBuilder() {
  }

  public static SendSmsVerifyCodeForLoginMessageBuilder builder() {
    return new SendSmsVerifyCodeForLoginMessageBuilder();
  }

  public SendSmsVerifyCodeForLoginMessageBuilder setAppId(Long appId) {
    this.appId = appId;
    return this;
  }

  public SendSmsVerifyCodeForLoginMessageBuilder setPhoneNumber(String phoneNumber) {
    this.phoneNumber = phoneNumber;
    return this;
  }

  public SendSmsVerifyCodeForLoginMessageBuilder setId(String id) {
    this.id = id;
    return this;
  }

  public SendSmsVerifyCodeForLoginMessageBuilder addExt(String key, String value) {
